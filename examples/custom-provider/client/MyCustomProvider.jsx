...
import { UIPlugin } from '@JSProj/core'
import { Provider } from '@JSProj/companion-client'
import { ProviderViews } from '@JSProj/provider-views'
import { h } from 'preact'

const defaultOptions = {}

export default class MyCustomProvider extends UIPlugin {
  constructor (JSProj, opts) {
    super(JSProj, opts)
    this.type = 'acquirer'
    ...
    this.provider = new Provider(JSProj, {
