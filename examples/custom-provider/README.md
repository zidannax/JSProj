# JSProj + Companion + Custom Provider Example

This example uses @JSProj/companion with a dummy custom provider.
...
corepack yarn workspace @JSProj-example/custom-provider start
```
