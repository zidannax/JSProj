...
yarn create || corepack yarn create
```
...
```bash
corepack yarn workspace @JSProj-example/aws-php exec "composer update"
```
...
```bash
corepack yarn workspace @JSProj-example/aws-php start
```
