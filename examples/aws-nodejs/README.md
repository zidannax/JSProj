# JSProj + AWS S3 with Node.JS

A simple and fully working example of JSProj and AWS S3 storage with Node.js (and
...
```sh
corepack yarn workspace @JSProj-example/aws-nodejs start
```
